...
if ($(this).val().length == 0) {
  ...
  $("#results").show();
          ...
          $("#results #seapop ul").click(function(e){
                      ...
                      $(".dropdown-menu .open").click(function(e){
                                $('#results').css('z-index', 100);
                                $('.dropdown-menu').css('z-index', 600);
                                $('.dropdown').css('z-index', 600);
                                });
...
$(function(){                                  
    var actionopen = $('.dropdown');
    var actionclose = $('');
    actionopen.on('click', function (e) {
        e.preventDefault();
    ...
    actionclose.on('click', function () {
        $(this).next('.dropdown-menu').toggleClass('open');
                        ...
                        geojson1.eachLayer(function(feature){
                          ...
                          $('#resta').css('position', 'static');



                            // $(".dropdown-menu li a").on('click touchend', function() {
                            //   $(this).toggleClass("open");
                            //   });

                              //     $("#b1").on('click touchend', function() {
                              //             $("#resta").toggleClass("open");
                              //             });

                              // $(".btn .btn-danger .dropdown-toggle").on('click touchend', function() {
                              // $("#resta").toggleClass("open");
                           
                              // });

                              $("#resta li a").on('click touchend', function() {
                              $("#resta").toggleClass("open");
                              });
                        ...
                        geojson2.eachLayer(function(feature){
                          ...
                          // $("#results").hide();
                          $('#results').css('z-index', 100);
                          $('#otherf').css('z-index', 600);
                          $('#otherf').css('position', 'static');
                              
                              // $("#b2").on('click touchend', function() {
                              //             $("#otherf").toggleClass("open");
                              //             });

                              // $(".btn .btn-warning .dropdown-toggle").on('click touchend', function() {
                              // $("#otherf").toggleClass("open");
                           
                              // });

                              $("#otherf li a").on('click touchend', function() {
                              $("#otherf").toggleClass("open");
                              });
                        ...
                        geojson3.eachLayer(function(feature){
                          ...
                          // $("#results").hide();
                          $('#results').css('z-index', 100);
                          $('#services').css('z-index', 600);
                          $('#services').css('position', 'static');
                          
                            // $("#b3").on('click touchend', function() {
                            //               $("#services").toggleClass("open");
                            //               });

                            //   $(".btn .btn-success .dropdown-toggle").on('click touchend', function() {
                            //   $("#services").toggleClass("open");
                           
                            //   });
                              $("#services li a").on('click touchend', function() {
                              $("#services").toggleClass("open");
                              });
                        ...
                        geojson4.eachLayer(function(feature){
                          ...
                          // $("#results").hide();
                          $('#results').css('z-index', 100);
                          $('#retail').css('z-index', 600);
                          $('#retail').css('position', 'static');
                          
                              // $("#b4").on('click touchend', function() {
                              //             $("#retail").toggleClass("open");
                              //             });


                              // $(".btn .btn-primary .dropdown-toggle").on('click touchend', function() {
                              // $("#retail").toggleClass("open");
                              // });

                              $("#retail li a").on('click touchend', function() {
                              $("#retail").toggleClass("open");
                              });
                        ...
                        geojson5.eachLayer(function(feature){
                          ...
                          // $("#results").hide();
                          $('#results').css('z-index', 100);
                          $('#beauhea').css('z-index', 600);
                          $('#beauhea').css('position', 'static');

                            // $("#b5").on('click touchend', function() {
                            //               $("#beauhea").toggleClass("open");
                            //               });

                            //   $(".btn .btn-info .dropdown-toggle").on('click touchend', function() {
                            //   $("#beauhea").toggleClass("open");
                           
                            //   });

                              $("#beauhea li a").on('click touchend', function() {
                              $("#beauhea").toggleClass("open");
                              });
...
// });
 ...
 $(document).on('click touchend', '.dropdown-menu li a', function (e) {
  e.stopPropagation();
});
